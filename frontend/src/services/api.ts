...
export async function fetchPlaces(
  params?: { q?: string; slugs?: string; place_type?: string; has_coords?: boolean; min_verses?: number; limit?: number; offset?: number }
  ...
  if (params?.min_verses !== undefined) sp.set("min_verses", String(params.min_verses));
  if (params?.limit) sp.set("limit", String(params.limit));
  if (params?.offset) sp.set("offset", String(params.offset));
  const qs = sp.toString();
